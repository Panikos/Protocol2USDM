...
_M11_SECTION_GUIDANCE = {
    '7': (
        "ICH M11 §7: Discontinuation of Trial Intervention and Participant "
        "Discontinuation/Withdrawal. Extract ALL of:\n"
        "- §7.1 Discontinuation of Trial Intervention — criteria for stopping "
        "drug/treatment, dose modifications, rechallenge rules\n"
        "- §7.2 Participant Discontinuation/Withdrawal from the Trial — "
        "voluntary withdrawal, investigator-initiated withdrawal, lost to "
        "follow-up procedures, data handling for withdrawn participants\n"
        "- §7.3 Stopping Rules — early termination criteria for the whole "
        "trial or individual sites, futility analysis triggers\n"
        "Look for headings containing: discontinu, withdraw, stopping rule, "
        "lost to follow, premature, removal from study, dose modification."
    ),
    '8': (
        "ICH M11 §8: Trial Assessments and Procedures. Extract ALL of:\n"
        "- §8.1 Efficacy Assessments — primary/secondary efficacy measures, "
        "scoring instruments, response criteria, assessment schedules\n"
        "- §8.2 Safety Assessments — vital signs, physical examinations, "
        "electrocardiograms (ECG), clinical laboratory tests, imaging\n"
        "- §8.3 Other Assessments — pharmacokinetic (PK) sampling, "
        "pharmacodynamic (PD) assessments, biomarkers, patient-reported "
        "outcomes (PRO), quality of life (QoL), immunogenicity\n"
        "- §8.4 Appropriateness of Assessments — rationale for selected "
        "assessments, validation of instruments\n"
        "Look for headings containing: assessment, procedure, efficacy, "
        "laboratory, ECG, vital sign, pharmacokinetic, biomarker, imaging."
    ),
    '9': (
        "ICH M11 §9: Adverse Events, Serious Adverse Events, and Other "
        "Safety. Extract ALL of:\n"
        "- §9.1 Definitions — AE, SAE, AESI, SUSAR definitions\n"
        "- §9.2 Adverse Event Collection Period — start/end of monitoring\n"
        "- §9.3 AE Recording and Reporting — grading (CTCAE), causality "
        "assessment, severity scales, expectedness determination\n"
        "- §9.4 SAE Reporting — timelines (24h/72h), expedited reporting, "
        "IND safety reports, CIOMS/MedWatch forms\n"
        "- §9.5 Adverse Events of Special Interest (AESI) — predefined "
        "events requiring enhanced surveillance\n"
        "- §9.6 Pregnancy — reporting, follow-up, partner pregnancy\n"
        "- §9.7 Medical Device Incidents (if applicable)\n"
        "Look for headings containing: adverse event, safety, SAE, serious, "
        "pharmacovigilance, AESI, pregnancy, reporting."
    ),
    '10': (
        "ICH M11 §10: Statistics. Extract ALL of:\n"
        "- §10.1 Statistical Hypotheses — null/alternative hypotheses, "
        "primary comparisons, multiplicity strategy\n"
        "- §10.2 Sample Size Determination — calculation assumptions, power, "
        "effect size, dropout rates, interim analysis adjustments\n"
        "- §10.3 Populations for Analyses — ITT, mITT, per-protocol, "
        "safety population definitions\n"
        "- §10.4 Statistical Analyses — primary analysis methods (ANCOVA, "
        "MMRM, logistic regression, etc.), secondary analyses, sensitivity "
        "analyses, subgroup analyses, handling of missing data (MCAR/MAR/MNAR)\n"
        "- §10.5 Interim Analyses — planned interim looks, alpha spending "
        "function, Data Monitoring Committee (DMC) charter\n"
        "Look for headings containing: statistic, sample size, analysis, "
        "hypothesis, interim, multiplicity, endpoint analysis, missing data."
    ),
    '11': (
        "ICH M11 §11: Oversight, Compliance, and Integrity. Extract ALL of:\n"
        "- §11.1 Regulatory and Ethical Considerations — IRB/IEC approval, "
        "regulatory authority submissions, Declaration of Helsinki\n"
        "- §11.2 Informed Consent — process, timing, reconsent, assent for "
        "minors, consent for genetic testing, electronic consent\n"
        "- §11.3 Data Protection — GDPR/HIPAA compliance, pseudonymization, "
        "data access controls, record retention\n"
        "- §11.4 Committees — DMC/DSMB, steering committee, adjudication "
        "committee, clinical endpoint committee\n"
        "- §11.5 Quality Management — risk-based monitoring, source data "
        "verification, protocol deviations, audits, inspections\n"
        "- §11.6 Data Management — eCRF, database lock, coding (MedDRA, "
        "WHO Drug), external data transfers\n"
        "- §11.7 Publication Policy and Dissemination\n"
        "- §11.8 Insurance and Compensation\n"
        "Look for headings containing: ethic, regulatory, informed consent, "
        "data protection, committee, quality, monitoring, compliance, oversight."
    ),
    '12': (
        "ICH M11 §12: Appendix — Supporting Information. Extract ALL of:\n"
        "- §12.1 Country/Region-Specific Requirements\n"
        "- §12.2 Contraceptive Guidance and Pregnancy Testing\n"
        "- §12.3 Liver Safety Monitoring (Hy's Law, DILI)\n"
        "- §12.4 Amendment History — changes, rationale, impacted sections\n"
        "- Any other supplementary appendix content\n"
        "Look in appendices or supplementary sections."
    ),
    '13': (
        "ICH M11 §13: Appendix — Glossary of Terms and Abbreviations.\n"
        "Extract any glossary or abbreviation tables found in the protocol."
    ),
    '14': (
        "ICH M11 §14: Appendix — References.\n"
        "Extract the reference/bibliography list from the protocol."
    ),
}
